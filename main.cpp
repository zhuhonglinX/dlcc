...
map<Token, int> op_precedence = {
    {Token::ASSIGN, 0}, {Token::LOR, 5},  {Token::LAND, 6}, {Token::EQ, 10},
    {Token::NEQ, 10},   {Token::LT, 15},  {Token::LE, 15},  {Token::GE, 15},
    {Token::GT, 15},    {Token::ADD, 20}, {Token::SUB, 20}, {Token::MUL, 21},
    {Token::DIV, 21},   {Token::MOD, 21},
};

map<Token, string> kw_map = {
    {Token::EQ, "=="},    {Token::NEQ, "!="},   {Token::LOR, "||"},
    {Token::LAND, "&&"},  {Token::LE, "<="},    {Token::LT, "<"},
    {Token::GE, ">="},    {Token::GT, ">"},     {Token::ADD, "+"},
    {Token::SUB, "-"},    {Token::MUL, "*"},    {Token::DIV, "/"},
    {Token::MOD, "%%"},   {Token::ASSIGN, "="}, {Token::KW_INT, "int"},
